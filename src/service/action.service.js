    ...
    return {
        ...
        execute: function() {
            ActionService = (function () {
                ...
                ActionService.prototype.getAllActionGroups = function () {
                    return this._http.get(Constant.baseUrl + 'action_group/Getallactiongroups')
                        .map(function (res) { return res.json(); });
                };
                ActionService.prototype.validateAllActions = function (actionGroups) {
                ...
                ActionService.prototype.saveAllActions = function (actionGroups) {
                    var headers = new http_1.Headers();
                    headers.append('Content-Type', 'application/json');
